      ...
      <Helmet>
        ...
        <script type="text/javascript">
          {`
            ...
            })(window, document,'script','https://mc.yandex.ru/metrika/tag.js?id=106318249', 'ym');

            ym(106318249, 'init', {ssr:true, webvisor:true, clickmap:true, ecommerce:"dataLayer", referrer: document.referrer, url: location.href, accurateTrackBounce:true, trackLinks:true});
          `}
        </script>
        <noscript>
          {`
            <div><img src="https://mc.yandex.ru/watch/106318249" style="position:absolute; left:-9999px;" alt="" /></div>
          `}
        </noscript>
        {/* /Yandex.Metrika counter */}
      </Helmet>
